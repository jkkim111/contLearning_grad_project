...
from robosuite.models.tasks import BinPickingTask, UniformRandomSampler
# from robosuite.models.task import BinPickingTask

class SawyerBinPicking(SawyerEnv):
    def __init__(
        self,
        gripper_type="TwoFingerGripper",
        table_full_size=(0.39, 0.49, 0.72), # 0.39, 0.49, 0.82
    ...
    def _load_model(self):
        ...
        self.ob_inits = [CanObject]*30 #, CanObject, CanObject, CanObject]
        self.vis_inits = [
            MilkVisualObject,
            BreadVisualObject,
            CerealVisualObject,
        ...
        self.item_names = ["Can"+str(i) for i in range(30)] # , "Can2", "Can3", "Can4"]
...
class SawyerBinPickingSingle(SawyerBinPicking):
    """
...
class SawyerBinPickingMilk(SawyerBinPicking):
    """
...
class SawyerBinPickingBread(SawyerBinPicking):
    """
...
class SawyerBinPickingCereal(SawyerBinPicking):
    """
...
class SawyerBinPickingCan(SawyerBinPicking):
    """
