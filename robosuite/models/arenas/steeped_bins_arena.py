...
class SteepedBinsArena(Arena):
    """Workspace that contains two bins placed side by side."""

    def __init__(
        self, table_full_size=(0.54, 0.54, 0.10), table_friction=(1, 0.005, 0.0001)
    ):
        """
        Args:
        ...
        """
        super().__init__(xml_path_completion("arenas/steeped_bins_arena.xml"))
    ...
    def bin2_abs(self):
        """Returns the absolute position of table top"""
        return string_to_array(self.bin2_body.get("pos"))