...
class BaxterEnv():
    def __init__(self, env, task='push', continuous=False, render=True, using_feature=False, random_spawn=False, rgbd=False, print_on=False, action_type='2D'):
        self.env = env
    ...
    def reset(self):
        ...
        if self.task=='reach':
            ...
            #####change######
            # the intial angle of the gripper aligns vertically to the pre_vec
            ...
            #initial position of (x,y,z) = c    olinear with object and target.
